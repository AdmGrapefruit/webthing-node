    ...
    get(req, res) {
        const description = (
            this.things.getThings().map((thing) => {
                ...
                description.base =
                    `${this.protocol}://${req.host}${thing.getHref()}`;
        ...
        res.end(this.createJson(res, description));
    }
}
...
class CoapPropertiesHandler extends CoapBaseHandler {
    ...
    get(req, res) {
        ...
        res.end(this.createJson(res, thing.getProperties()));
    }
}
...
class CoapPropertyHandler extends CoapBaseHandler {
    ...
    get(req, res) {
        ...
        if (thing.hasProperty(propertyName)) {
            res.end(this.createJson(res, {[propertyName]: thing.getProperty(propertyName)}));
        } else {
            res.statusCode = 404;
            res.end();
        }
...
class CoapActionsHandler extends CoapBaseHandler {
    ...
    post(req, res) {
        ...
        res.statusCode = 201;
        res.end(this.createJson(res, response));
    }
}
...
class CoapActionHandler extends CoapBaseHandler {
    ...
    get(req, res) {
        ...
        res.end(this.createJson(res, thing.getActionDescriptions(actionName)));
    }
...
class CoapActionIDHandler extends CoapBaseHandler {
    ...
    get(req, res) {
        ...
        res.end(this.createJson(res, action.asActionDescription()));
    }
...
class CoapEventsHandler extends CoapBaseHandler {
    ...
    get(req, res) {
        ...
        res.end(this.createJson(res, thing.getEventDescriptions()));
    }
}
...
class CoapEventHandler extends CoapBaseHandler {
    ...
    get(req, res) {
        ...
        res.end(this.createJson(res, thing.getEventDescriptions(eventName)));
    }
}
